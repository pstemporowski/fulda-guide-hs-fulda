...
class Anleitungenvalidieren extends StatelessWidget {
  Anleitungenvalidieren({
    Key? key,
  }) : super(key: key);
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 644.0, end: 87.0),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: const AssetImage('lib/assets/images/Vali.jpeg'),
                      fit: BoxFit.fill,
                    ),
                  ),
                  margin: EdgeInsets.fromLTRB(0.0, 166.0, 0.0, 0.0),
                ),
                Pinned.fromPins(
