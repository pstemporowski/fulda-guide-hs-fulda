...
class AnleitungenRechenzentrum extends StatelessWidget {
                        ...
                        child: Text.rich(
                          TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text:
                                    'Bei Fragen (zu fd-Nummer, E-Mail, horstl etc.) kann man sich unter diesem Link selbst schlau machen:\nhttps://doku.rz.hs-fulda.de/doku.php/docs:start?redirect=1\n\nPersönlicher Kontakt:\n',
                              ),
                              TextSpan(
                                text: 'Telefon:',
                                style: TextStyle(
                              ...
                              TextSpan(
                                text: ' fdnr-support@rz.hs-fulda.de\n',
                              ),
                              TextSpan(
                                text: 'Ticketsystem:',
                                style: TextStyle(
